...
static const CGFloat kVideoControlBarHeight = 64;
static const CGFloat kVideoControlAnimationTimeinterval = 0.5;
...
- (void)layoutSubviews
{
    ...
    self.backButton.frame = CGRectMake(0, 20, 100, 44);
    self.closeButton.frame = CGRectMake(CGRectGetWidth(self.bounds) - 80, 20, 80, 44);
...
- (void)animateHide
{
    ...
    [UIView animateWithDuration:kVideoControlAnimationTimeinterval animations:^{
        self.topBar.frame = CGRectMake(CGRectGetMinX(self.bounds), -64, CGRectGetWidth(self.bounds), kVideoControlBarHeight);
        self.bottomBar.frame = CGRectMake(CGRectGetMinX(self.bounds), CGRectGetHeight(self.bounds), CGRectGetWidth(self.bounds), kVideoControlBarHeight);
...
//        [_fullScreenButton setImage:[UIImage imageNamed:@"kr-video-player-fullscreen"] forState:UIControlStateNormal];
        [_fullScreenButton setTitle:@"PO" forState:UIControlStateNormal];
...
- (UIButton *)backButton
{
    if (!_backButton) {
        ...
        [_backButton setTitle:@"重新录制" forState:UIControlStateNormal];
...
- (UIButton *)closeButton
{
    if (!_closeButton) {
        ...
        [_closeButton setTitle:@"下一步" forState:UIControlStateNormal];
